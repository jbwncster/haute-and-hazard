...
- [Alternate Two-Placement Stage Rules](docs/ALTERNATE_TWO_PLACEMENT_STAGE_RULES.md) — experimental Stage Winner → Runner-Up → optional Dragdagulan† → Curtain Call module for A/B playtesting; not canonical v7.8.\n- [Solo Circuit Automa Playtest](docs/SOLO_CIRCUIT_AUTOMA_PLAYTEST.md) — experimental one-player House Queen module using a proposed 18-card behavior deck, solo Dragdagulan†, difficulty levels, and optional Queen personalities; not canonical v7.8.
