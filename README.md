...
- printed Tips counted once from cards currently in hand;
...
- a fully unique **144-card Wardrobe**:
  ...
  - 14 unique Actions;
- corrected starter wording so printed Tips are not paid twice.
...
During Tip Count, add the printed Tip values of every card currently in your hand. Counting a card does not discard it; it may still be played/equipped afterward. Its printed Tips are not counted again merely because it leaves the hand.
