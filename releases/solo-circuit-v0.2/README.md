...
Plus quick reference, trackers/counters, and playtest log.
...
- the optional solo deck remains separate from the 240-card base-game deck.
...
If a binary is not visibly committed or attached, do not relabel the archived v0.1 ZIP.
